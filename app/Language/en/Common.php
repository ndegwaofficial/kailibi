...
return [
	...
	"software_short" => "Kailibi POS",
	"software_title" => "Kailibi POS",
	"state" => "State",
	"submit" => "Submit",
	"total_spent" => "Total Spent",
	"unknown" => "Unknown",
	"view_recent_sales" => "View Recent Sales",
	"website" => "kailibihardware.co.ke",
	"welcome" => "Welcome",
	"welcome_message" => "Welcome to Kailibi Hardware POS, click a module below to get started.",
	"yes" => "Yes",
	"you_are_using_kailibiPOS" => "",
	"zip" => "Postal Code",
];
